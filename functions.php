...
function bd_handle_contact_form() {
    ...
    if ( ! empty( $_POST['bd_website_url'] ) ) {
        $url = isset( $_POST['redirect_url'] ) ? esc_url_raw( $_POST['redirect_url'] ) : home_url( '/contact' );
        wp_safe_redirect( add_query_arg( 'contact', 'error', $url ) );
        exit;
    }

    $first   = isset( $_POST['bd_first_name'] ) ? sanitize_text_field( wp_unslash( $_POST['bd_first_name'] ) ) : '';
    $last    = isset( $_POST['bd_last_name'] )  ? sanitize_text_field( wp_unslash( $_POST['bd_last_name'] ) )  : '';
    ...
    $service = isset( $_POST['bd_service'] )    ? sanitize_text_field( wp_unslash( $_POST['bd_service'] ) )    : '';
    $budget  = isset( $_POST['bd_budget'] )     ? sanitize_text_field( wp_unslash( $_POST['bd_budget'] ) )     : '';
    $message = isset( $_POST['bd_message'] )    ? sanitize_textarea_field( wp_unslash( $_POST['bd_message'] ) ): '';
    $redirect= isset( $_POST['redirect_url'] )  ? esc_url_raw( wp_unslash( $_POST['redirect_url'] ) )          : home_url( '/contact' );

...
<section class="port-list">
    <div class="container">
        ...
        <?php
        /* ── Live WP posts (when case studies are published) ── */
            ...
            <div class="port-row__content">
                ...
                <div class="port-row__actions">
                    <a href="<?php the_permalink(); ?>" class="port-row__btn port-row__btn--primary">
                        View Case Study <span class="port-row__arrow">→</span>
                    </a>
                    <?php if ( $url ) : ?>
        ...
        /* ── Static fallback — full Tier 1 + Tier 2 roster ── */

        $tier1_label = '<div class="port-tier-label"><span>Featured Work</span></div>';
        $tier2_label = '<div class="port-tier-label port-tier-label--2"><span>More Work</span></div>';
        ...
        $projects = array(
            ...
            array(
                ...
                'badge'   => 'E-Commerce',
                'preview' => '
                    <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:11px;padding:24px;height:100%;background:linear-gradient(135deg,#120820 0%,#2a1045 60%,#1a0a35 100%);text-align:center">
                        <div style="font-size:8px;letter-spacing:.28em;color:#b06fcc;text-transform:uppercase">A box full of beauty</div>
                        <div style="font-size:22px;letter-spacing:.22em;color:#f0d8ff;font-weight:300;font-style:italic">CHIC BEAUTY BOX</div>
                        ...
                        <div style="background:#b06fcc;color:#fff;font-size:8px;letter-spacing:.2em;text-transform:uppercase;padding:10px 26px;border-radius:40px">Get Your Box</div>
                    </div>',
            ),
            array(
                'tier'    => 1,
                ...
                'desc'    => 'A high-impact festival launch site built to drive pre-sale momentum — live countdown timer, early access email capture, social integrations, and a fully animated marquee experience.',
                'tags'    => array( 'Festival Site', 'Live Countdown', 'Email Capture', 'Animated UI' ),
                'badge'   => 'Event Website',
                'preview' => '
                    <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:9px;padding:24px;height:100%;background:#000;text-align:center;position:relative">
                        ...
                        <div style="position:relative;font-size:8px;color:rgba(255,255,255,.4);letter-spacing:.12em">August 15, 2026 · Toronto</div>
            ...
            array(
                ...
                'badge'   => 'Entertainment',
                'preview' => '
                    <div style="display:flex;flex-direction:column;justify-content:center;padding:26px;height:100%;background:#050505;position:relative;gap:10px">
                        ...
                        <div style="position:relative;font-size:22px;font-weight:900;color:#fff;text-transform:uppercase;line-height:1.08;max-width:200px">WE BRING AFRICA TO THE WORLD</div>
            ...
            array(
                ...
                'badge'   => 'Enterprise',
                'preview' => '
                    <div style="display:flex;flex-direction:column;justify-content:center;padding:26px;height:100%;background:linear-gradient(135deg,#0a1628 0%,#0d2244 100%);gap:11px">
                        <div style="font-size:8px;letter-spacing:.2em;color:#4d9fff;text-transform:uppercase">Telecom · Enterprise · 5 Brands</div>
                        <div style="font-size:26px;font-weight:900;color:#fff;letter-spacing:.04em;text-transform:uppercase">DISTRIBUTEL<br>GROUP</div>
                        <div style="height:2px;width:44px;background:linear-gradient(90deg,#2d4ef5,transparent)"></div>
                        <div style="font-size:9px;color:rgba(255,255,255,.42);line-height:1.6;max-width:200px">Internet, phone & TV services coast to coast for 100K+ Canadian customers.</div>
                        <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:4px">
                            <div style="background:rgba(45,78,245,.25);color:#7b9fff;font-size:7px;letter-spacing:.1em;padding:3px 10px;border-radius:40px">YAK.ca</div>
                            <div style="background:rgba(45,78,245,.25);color:#7b9fff;font-size:7px;letter-spacing:.1em;padding:3px 10px;border-radius:40px">Thinktel</div>
                            <div style="background:rgba(45,78,245,.25);color:#7b9fff;font-size:7px;letter-spacing:.1em;padding:3px 10px;border-radius:40px">Navigata</div>
                            <div style="background:rgba(45,78,245,.25);color:#7b9fff;font-size:7px;letter-spacing:.1em;padding:3px 10px;border-radius:40px">Wholesale</div>
                        </div>
                    </div>',
            ),
            array(
                ...
                'badge'   => 'B2B Hardware',
                'preview' => '
                    <div style="display:flex;flex-direction:column;justify-content:center;padding:26px;height:100%;background:linear-gradient(135deg,#0f0505 0%,#2a0808 100%);gap:11px">
                        <div style="font-size:8px;letter-spacing:.2em;color:#ff4444;text-transform:uppercase">Hardware Manufacturer · B2B</div>
                        <div style="font-size:26px;font-weight:900;color:#fff;letter-spacing:.04em;text-transform:uppercase">LAVA<br>COMPUTERS</div>
            ...
            array(
                ...
                'desc'    => 'Payment processing platform built in-house — trust-driven design, compliance-first UX, and a high-converting merchant onboarding flow that builds confidence at every step.',
                'tags'    => array( 'Fintech UX', 'Compliance', 'Conversion', 'Onboarding Flow' ),
                'badge'   => 'Fintech',
                'preview' => '
                    <div style="display:flex;flex-direction:column;justify-content:center;padding:26px;height:100%;background:linear-gradient(135deg,#041a10 0%,#082e18 100%);gap:11px">
                        <div style="font-size:8px;letter-spacing:.2em;color:#22cc66;text-transform:uppercase">Fintech · Payments · In-House</div>
                        <div style="font-size:26px;font-weight:900;color:#fff;letter-spacing:.04em;text-transform:uppercase">SEKURE<br>MERCHANTS</div>
            ...
            array(
                ...
                'badge'   => 'Enterprise',
                'preview' => '
                    <div style="display:flex;flex-direction:column;justify-content:center;padding:26px;height:100%;background:linear-gradient(135deg,#0d1520 0%,#1a2840 100%);gap:10px">
            ...
            array(
                ...
                'badge'   => 'SaaS',
                'preview' => '
                    <div style="display:flex;flex-direction:column;justify-content:center;padding:26px;height:100%;background:linear-gradient(135deg,#0a1a2a 0%,#102030 100%);gap:10px">
                        ...
                        <div style="background:#38b2ff;color:#000;font-size:8px;letter-spacing:.15em;text-transform:uppercase;padding:8px 18px;border-radius:40px;width:fit-content;font-weight:700;margin-top:4px">Book Now</div>
                    </div>',
            ),
            array(
                'tier'    => 2,
                ...
                'badge'   => 'Non-Profit',
                'preview' => '
                    <div style="display:flex;flex-direction:column;justify-content:center;padding:26px;height:100%;background:linear-gradient(135deg,#111820 0%,#1a2230 100%);gap:10px">
            ...
            array(
                ...
                'preview' => '
                    <div style="display:flex;flex-direction:column;justify-content:center;padding:26px;height:100%;background:linear-gradient(135deg,#1a1200 0%,#2e2000 100%);gap:10px">
                        ...
                        <div style="background:#ffaa22;color:#000;font-size:8px;letter-spacing:.15em;text-transform:uppercase;padding:8px 18px;border-radius:40px;width:fit-content;font-weight:700;margin-top:4px">Get a Quote</div>
                    </div>',
            ),
            array(
                'tier'    => 2,
                ...
                'badge'   => 'Beauty',
                'preview' => '
                    <div style="display:flex;flex-direction:column;justify-content:center;align-items:center;padding:26px;height:100%;background:linear-gradient(135deg,#1a0820 0%,#280a30 100%);gap:10px;text-align:center">
                        <div style="font-size:8px;letter-spacing:.25em;color:#dd88cc;text-transform:uppercase">Beauty · Lashes · Toronto</div>
                        <div style="font-size:20px;font-weight:300;color:#f8e8ff;letter-spacing:.18em;font-style:italic">Lashes Toronto<br>& Beauty</div>
                        <div style="height:1px;width:40px;background:linear-gradient(90deg,transparent,#dd88cc,transparent)"></div>
                        <div style="font-size:9px;color:rgba(255,255,255,.4);line-height:1.6;max-width:180px">Premium lash extensions & beauty services in Toronto. Book your appointment online.</div>
                        <div style="background:#dd88cc;color:#fff;font-size:8px;letter-spacing:.15em;text-transform:uppercase;padding:8px 20px;border-radius:40px;font-weight:600;margin-top:4px">Book Now</div>
                    </div>',
            ),
            array(
                'tier'    => 2,
                ...
                'badge'   => 'Entertainment',
                'preview' => '
                    <div style="display:flex;flex-direction:column;justify-content:center;padding:26px;height:100%;background:linear-gradient(135deg,#100a1a 0%,#1e1030 100%);gap:10px">
            ...
            array(
                ...
                'badge'   => 'Health',
                'preview' => '
                    <div style="display:flex;flex-direction:column;justify-content:center;padding:26px;height:100%;background:linear-gradient(135deg,#1a0a0a 0%,#2e1518 100%);gap:10px">
            ...
            array(
                ...
                'badge'   => 'Wellness',
                'preview' => '
                    <div style="display:flex;flex-direction:column;justify-content:center;padding:26px;height:100%;background:linear-gradient(135deg,#0a1a12 0%,#122a1a 100%);gap:10px">
                        <div style="font-size:8px;letter-spacing:.2em;color:#44cc88;text-transform:uppercase">Health · Wellness · Community</div>
                        <div style="font-size:19px;font-weight:700;color:#fff;letter-spacing:.02em;line-height:1.2">Healing at the<br>Intersections</div>
            ...
            array(
                ...
                'badge'   => 'Finance',
                'preview' => '
                    <div style="display:flex;flex-direction:column;justify-content:center;padding:26px;height:100%;background:linear-gradient(135deg,#0a0e18 0%,#121828 100%);gap:10px">
            ...
            array(
                ...
                'badge'   => 'Hospitality',
                'preview' => '
                    <div style="display:flex;flex-direction:column;justify-content:center;padding:26px;height:100%;background:linear-gradient(135deg,#100c08 0%,#201810 100%);gap:10px">
                        <div style="font-size:8px;letter-spacing:.2em;color:#ddaa66;text-transform:uppercase">Real Estate · Hospitality</div>
                        <div style="font-size:22px;font-weight:300;color:#fff;letter-spacing:.14em;font-style:italic">Ms Lee Place</div>
            ...
            array(
                ...
                'preview' => '
                    <div style="display:flex;flex-direction:column;justify-content:center;padding:26px;height:100%;background:linear-gradient(135deg,#0a0a0a 0%,#1a1a1a 100%);gap:10px">
                        <div style="font-size:8px;letter-spacing:.2em;color:#ffffff;text-transform:uppercase;opacity:.4">Personal Brand · Creative</div>
            ...
            array(
                ...
                'badge'   => 'Events',
                'preview' => '
                    <div style="display:flex;flex-direction:column;justify-content:center;align-items:center;padding:26px;height:100%;background:linear-gradient(135deg,#1a0805 0%,#2e1008 100%);gap:10px;text-align:center;position:relative">
                        ...
                        <div style="position:relative;font-size:8px;letter-spacing:.25em;color:#ff6622;text-transform:uppercase">Events · Afro Caribbean Culture</div>
                        ...
                        <div style="position:relative;height:2px;width:40px;background:linear-gradient(90deg,transparent,#ff6622,transparent)"></div>
                        <div style="position:relative;font-size:9px;color:rgba(255,255,255,.4);line-height:1.6">Celebrating African & Caribbean culture through music, dance and unforgettable events.</div>
                    </div>',
            ),
            array(
                'tier'    => 2,
                ...
                'badge'   => 'Community',
                'preview' => '
                    <div style="display:flex;flex-direction:column;justify-content:center;padding:26px;height:100%;background:linear-gradient(135deg,#0e1218 0%,#141c26 100%);gap:10px">
                        <div style="font-size:8px;letter-spacing:.2em;color:#7799bb;text-transform:uppercase">Community · Organization</div>
                        <div style="font-size:26px;font-weight:900;color:#fff;letter-spacing:.06em;text-transform:uppercase">MLRS.ca</div>
            ...
            <div class="port-row__content">
                ...
                <div class="port-row__actions">
                    <a href="<?php echo esc_url( $p['url'] ); ?>" target="_blank" rel="noopener" class="port-row__btn port-row__btn--primary">
                        View Live Site <span class="port-row__arrow">→</span>
                    </a>
                </div>
            </div>
            <div class="port-row__visual">

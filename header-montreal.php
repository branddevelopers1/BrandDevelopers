...
<nav class="navbar navbar-expand-xxl navbar-light bg-light fixed-top">
  <div class="container-fluid" id="ebmtlheader">
    <a class="navbar-brand" href="/"><img src="<?php echo get_template_directory_uri(); ?>/images/MTL-BlkFont.png" alt="E Block Inc."></a>

    <?php wp_nav_menu(array(
        'theme_location' => 'mtl-menu-main',
